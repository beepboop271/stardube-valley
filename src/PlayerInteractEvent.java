...
public class PlayerInteractEvent extends EventObject {
   ...
   * @param selectedItemIndex The index of the inventory with the selected item's (during creation of this instance) index'.
   */
   ...
   * Retrieves the index of the selected item that the player had during creation of this event.

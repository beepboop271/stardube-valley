...
public class MenuSystemEventListener extends MouseAdapter {
  ...
  public void mouseReleased(MouseEvent e) {
    ...
    if (this.menuPanel.getCurrentPage().equals("mainPage")
          && this.menuPanel.getStartButton().inButton(mouseX, mouseY)) {
      this.shouldStartGame = true;

    } else if (this.menuPanel.getCurrentPage().equals("mainPage")
               && this.menuPanel.getLoreButton().inButton(mouseX, mouseY)) {
      this.menuPanel.setCurrentPage("lorePage");

    } else if (this.menuPanel.getCurrentPage().equals("mainPage")
               && this.menuPanel.getCreditsButton().inButton(mouseX, mouseY)) {
      this.menuPanel.setCurrentPage("creditsPage");

    } else if ((this.menuPanel.getCurrentPage().equals("lorePage")
                || this.menuPanel.getCurrentPage().equals("creditsPage"))
